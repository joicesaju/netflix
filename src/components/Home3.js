...
function Home() {
  ...
  const[data,setData]=useState([]);
    ...
    {
        const result =await instance.get(requests.fetchHorrorMovies);
    ...
    <div className='home'>
           ...
           <div className='movies'>
        {
            movies.map(movie=>(
              ...
              <Link to={'/md'}>
                 <img style={{width:"170px", height:"200px"}} src={`${base_url}${movie.poster_path}`} className="movie" onClick={()=>getdata(movie)}/>
              </Link>
